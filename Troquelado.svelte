...
<section class="text-gray-600 body-font">
  <div class="container px-5 py-24 mx-auto  flex justify-center">
    ...
    <div class=" lg:w-2/6 md:w-1/2 bg-gray-300 rounded-lg p-8 flex flex-col  w-full mt-10 md:mt-0">
      <h2 class="text-gray-900 text-lg font-medium title-font mb-5">Envases Troquelados</h2>
    {#each datanueva as item}
      ...
      <div class="relative mb-4">
        ...
        <input bind:value={item.largoTroquelar} type=number id="largoTroquelar" name="largoTroquelar" placeholder='Enter Largo para Troquelar...' class="w-full bg-white rounded border border-gray-300 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
      </div>

      <div class="relative mb-4">
        <label for="anchoTroquelar" class="leading-7 text-sm text-gray-600">Ancho para Troquelar</label>
        <input bind:value={item.anchoTroquelar} type=number id="ancho" name="ancho" placeholder='Enter Ancho para Troquelar...' class="w-full bg-white rounded border border-gray-300 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
      </div>
    ...
    {/each}
      ...
      <p class="text-xs text-gray-500 mt-3">¿Yo escribí eso, aquí, en Buenos Aires, mientras oía llegar la lluvia, el invierno, la noche? Andrés Rivera</p>
    </div>
  </div>
</section>
