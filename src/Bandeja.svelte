...
<section class="text-gray-600 body-font">
  <div class="container px-5 py-24 mx-auto  flex justify-center">
    ...
    <div class=" lg:w-2/6 md:w-1/2 bg-gray-300 rounded-lg p-8 flex flex-col  w-full mt-10 md:mt-0">
      <h2 class="text-gray-900 text-lg font-medium title-font mb-5">Bandejas</h2>
    ...
    {/each}
      ...
      <p class="text-xs text-gray-500 mt-3">Por último, me despido con una sonrisa de tránsfuga, picardías de putañero que descubrió su hombre; te mando un beso con saliva de guitarrero infame de zambas berretas, de gavilán de tierras malas. Cucurto</p>
    </div>
  </div>
</section>
