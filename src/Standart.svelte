...
<section class="text-gray-600 body-font">
  <div class="container px-5 py-24 mx-auto  flex justify-center">
    ...
    <div class=" lg:w-2/6 md:w-1/2 bg-gray-300 rounded-lg p-8 flex flex-col  w-full mt-10 md:mt-0">
      <h2 class="text-gray-900 text-lg font-medium title-font mb-5">Cajas Standart</h2>
    {#each datanueva as item}
      ...
      <div class="relative mb-4">
        ...
        <select bind:value={item.aletasSuperiores} id="aletasSup" name="aletasSup"  class="w-full bg-white rounded border border-gray-300 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
      ...
      <div class="relative mb-4">
        ...
        <select bind:value={item.aletasInferiores} id="aletasInf" name="aletasInf"  class="w-full bg-white rounded border border-gray-300 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                   <option disabled selected value>Seleccione Tipo Aletas</option>
                    <option value='Simples'>Simples</option>
                    <option value='Dobles'>Dobles</option>
                    <option value='Encimadas'>Encimadas</option>
    ...
    {/each}
      ...
      <p class="text-xs text-gray-500 mt-3">Habían vivido bastante tiempo. Qué inmutable era la vida, qué inmutable era todo. ¿Cómo puede decirse que el tiempo pasa? El tiempo es un cansancio que asumimos. Eduardo Mallea</p>
    </div>
  </div>
</section>
